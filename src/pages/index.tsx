  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="HR Information System - Streamlining your HR processes, from employee data management to vacations and payroll handling, all in one intuitive platform."
        />
      </Head>
      <ConfigureCodeBanner
        ...
        >
          <Box>
            ...
            <Text size="2xl" mb={{ base: '32px', lg: '48px' }} color="base.content" opacity="0.6">
              {`HR Information System - Streamlining your HR processes, from employee data management to vacations and payroll handling, all in one intuitive platform.`}
            </Text>
            <Box
